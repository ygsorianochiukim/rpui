...
import { IonText, IonItem, IonList, IonSelect, IonSelectOption, IonAlert, AlertController } from "@ionic/angular/standalone";
...
@Component({
  ...
  imports: [IonSelectOption, IonSelect, IonList, IonItem, HttpClientModule, CommonModule, FormsModule, ModalComponent],
  providers: [UserService, PositionService, AccessService, AccessLineService, LoginService],
})
export class UserAccessComponent implements OnInit {
  ...
  getId(s_bpartner_employee_id: number) {
    ...
    if (selectedUser) {
      ...
      this.UserAccessLineFields.s_bpartner_employee_id = selectedUser.s_bpartner_employee_id!;
      this.UserAccess.s_bpartner_employee_id = selectedUser.s_bpartner_employee_id!;
      this.listisVisible = false;
    }
  }
  Insert() {
